...
from data import get_generator, seed_worker
...
def get_data_loader(config: argparse.Namespace) -> torch.utils.data.DataLoader:
    ...
    data_loader = data.DataLoader(dataset, batch_size=batch_size, worker_init_fn=seed_worker, generator=get_generator())
